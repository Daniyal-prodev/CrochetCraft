...
class AuthManager {
    ...
    setUser(userData) {
        ...
        // Also update user in users array if exists
        const users = JSON.parse(localStorage.getItem('users')) || [];
        ...
        modal.innerHTML = `
            <div class="modal-content">
                ...
                <form class="profile-edit-form">
                    ...
                    <div class="form-group">
                        <label>Bio</label>
                        <textarea name="bio" placeholder="Tell us about yourself...">${this.currentUser.bio || ''}</textarea>
                    </div>
                    
                    <div class="form-group">
                        <label>Location</label>
                        <input type="text" name="location" value="${this.currentUser.location || ''}" placeholder="City, Country">
                    </div>
